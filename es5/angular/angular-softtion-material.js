...
/*
 Angular Softtion Material v2.0.9
...
(function (factory) {
    ...
    function AlertDirective($timeout) {
        return {
            ...
            link: function ($scope, $element) {
                ...
                $scope.$watch(function () { return $scope.ngDuration; },
                    function (newValue) {
                        if (isNaN(newValue)) $scope.ngDuration = 4000;
                    });
                
                $scope.$watch(function () { return $scope.ngOpen; },
                    function (newValue) { if (newValue) openAlert(); });
                
                $scope.$watch(function () { return $scope.ngClose; },
                    function (newValue) { if (newValue) closeAlert(); });
                    
                button.html("close"); $element.append(button);
                
                button.click(function () { $scope.$apply(function () { closeAlert(); }); });
                    
                function openAlert() {
                    $element.addClass(Classes.SHOW); $scope.ngVisible = true;
                    $scope.ngOpen = false; cancelPromise();
                    
                    promise = $timeout(function () { hideAlert(); }, $scope.ngDuration);
                }
    ...
    function AppBarDirective($window, $appBody, $appContent, $windowResize) {
        ...
        return {
            ...
            link: function ($scope, $element) {
                ...
                $windowResize.addListener(appBarWR, function (window) {
    ...
    function AudioDirective() {
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $scope.$watch(function () { return $scope.ngAudio; },
    ...
    function AutoCompleteDirective($window) {
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $scope.$watch(function () { return $scope.suggestions; }, 
                    function (newValue) {
                ...
                $scope.$watch(function () { return $scope.input; }, 
                    function (newValue, oldValue) {
                        if (newValue !== oldValue && $scope.inputActive)
                            listener.launch(Listeners.CHANGED_TEXT);
                    });

                $scope.$watch(function () { return $scope.clearModel; }, 
                    function (newValue) {
                        if (newValue === true) {
                ...
                $scope.$watch(function () { return $scope.ngOption; },
                    function (newValue) {
                        $scope.isOptionable = softtion.isDefined(newValue);
                    });
                    
                $scope.$watch(function () { return $scope.ngItemsVisible; }, 
                    function (newValue, oldValue) {
                        if (isNaN(newValue)) {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $scope.$watch(function () { return $scope.options; },
                    function (newValue) {
                        ...
                        softtion.forEach(newValue, function (option, index) {
                            if (option.active) {
                ...
                function removeActiveOptions() {
                    $scope.options.forEach(function (option) { option.active = false; });
                }
    ...
    function BottomSheetDirective($bottomSheet) {
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $attrs.$observe("marginTop", function () {
                ...
                backdrop.click(function () { bottomSheet.hide(); });
                ...
                $element.transitionend(function (event) {
                    $scope.$apply(function () {
                        ...
                        if (target === content[0] && transition === "transform")
                            listener.launch(
                                ($element.hasClass(Classes.SHOW)) ? Listeners.SHOW : Listeners.HIDE
                            );
                    });
                });
            }
    ...
    function ButtonDirective() {
        return {
            ...
            link: function ($scope, $element) {
                $scope.$watch(function () { return $scope.disabledRipple; },
                    function (newValue) {
    ...
    function CarouselDirective($interval, $timeout) {
        return {
            ...
            link: function ($scope, $element) {
                ...
                $scope.$watch(function () { return $scope.gallery; }, 
                    function (newValue) {
                        if (!softtion.isArray(newValue)) {
    ...
    function CatalogDirective($window, $windowResize) {
        return {
            ...
            link: function ($scope, $element) {
                ...
                $scope.$watch(function () { return $scope.actions; },
                    function (newValue) {
                        if (!softtion.isArray(newValue)) $scope.actions = [];
                    });
                    
                $scope.$watch(function () { return $scope.widthUniqueView; },
                    function (newValue) {
                ...
                $windowResize.addListener(keyCatalog, function (window) {
                    if (!softtion.isInPage($element[0])) {
    ...
    function ChipInputDirective() {
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $scope.$watch(function () { return $scope.maxCount; },
                    function (newValue) {
    ...
    function DatePickerDirective($body) {
        ...
        return {
            ...
            link: function ($scope, $elememt) {
                ...
                $scope.$watch(function () { return $scope.minDate; }, 
                    function (newValue, oldValue) {
                        if (softtion.isUndefined(newValue)) return;
                ...
                $scope.$watch(function () { return $scope.maxDate; }, 
                    function (newValue, oldValue) {
                        if (softtion.isUndefined(newValue)) return;
                ...
                $scope.changedMonth = function (event) {
                    ...
                    setTimeout(function () { table.removeClass(classTransition); }, 300);
    ...
    function ExpansionPanelDirective() {
        ...
        return {
            ...
            link: function ($scope, $element) {
                ...
                $scope.$watch(function () { return $scope.ngExpand; },
                    function (newValue) {
                        if (newValue) {
                ...
                header.click(function () {
                    $scope.$apply(function () { $scope.ngExpand = !$scope.ngExpand; });
                });

                content.resize(function () { if ($scope.ngExpand) expandElement(); });
                ...
                box.on("click", function ($event) {
                    if ($element.hasClass(Classes.ACTIVE)) {
                        if (box.is($event.target))
                            $scope.$apply(function () { $scope.ngClose = true; });
                        
                        return; // Componente se encuentra abierto
                    }
                    
                    $scope.$apply(function () { $scope.ngOpen = true; });
                });
    ...
    function FabMenuDirective() {
        return {
            ...
            link: function ($scope, $element) {
                ...
                $element.animationstart(function () { orbit.css("height", "200px"); });
                
                $element.animationend(function () { orbit.css("height", "0px"); });
    ...
    function FabSpeedDialDirective() {
        return {
            ...
            link: function ($scope, $element) {
                ...
                button.on("click.fab-speeddial", function () {
    ...
    function FileChooserDirective($timeout, $sce, $material) {
        return {
            ...
            link: function ($scope, $element) {
                ...
                $scope.$watch(function () { return $scope.fileTypes; },
                    function (newValue) {
                ...
                $scope.selectFile = function ($event) { 
                    ...
                    setTimeout(function () { fileInput.click(); }, 125); $event.stopPropagation();
                };
    ...
    function FormNavigationDirective($formNavigation) {
        return {
            ...
            link: function ($scope, $element) {
                ...
                backdrop.click(function () { if (!$scope.ngPersistent) formNavigation.hide(); });
    ...
    function GridDirective() {
        return {
            ...
            link: function ($scope, $element) {
                $scope.$watch(function () { return $scope.columns; },
                    function (newValue) {
        ...
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $scope.cropImage = function () {
                    ...
                    canvasProcessor[0].toBlob(function (blob) {
                        $scope.$apply(function () { $scope.ngListener({ $result: blob }); });
                ...
                $scope.applyBlackAndWhite = function () {
                    contextContent.putImageData(setFilterImageData(
                        ...
                        function (pixels, posR, posG, posB) {
    ...
    function LabelFieldDirective() {
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $attrs.$observe("iconDescription", function () {
                    $scope.isIconDescription = softtion.isText($attrs.iconDescription);
                });

                $attrs.$observe("iconImg", function () {
    ...
    function NotificationDirective($appContent) {
        return {
            ...
            link: function ($scope, $element) {
                ...
                $scope.$watch(function () { return $scope.ngVisible; },
                    function (newValue) {
                        if (newValue) {
                            if (!isAppbarPatent) {
    ...
    function PaginationDirective($filter) {
        return {
            ...
            link: function ($scope) {
                ...
                $scope.$watch(function () { return $scope.ngFilterParam; },
                    function (newValue) {
                ...
                $scope.$watch(function () { return $scope.ngIndex; },
                    function (newValue, oldValue) {
                        if (isNaN(newValue)) {
                ...
                $scope.$watch(function () { return $scope.ngCount; },
                    function (newValue, oldValue) {
                        if (isNaN(newValue)) {
                ...
                $scope.$watchCollection(function () { return $scope.suggestions; },
                    function (newValue, oldValue) {
                        if (softtion.isArray(newValue)) {
                            if (newValue.isEmpty()) {
    ...
    function ProgressBarDirective($progressBar) {
        return {
            ...
            link: function ($scope, $element) {
                ...
                $scope.$watch(function () { return $scope.determinate; },
                    function (newValue) {
                        if (!newValue) return; // Fin progreso
                        
                        progressBar.determinate($scope.duration, function () {
                            $scope.determinate = false; listener.launch(Listeners.DETERMINATE);
                        });
                    });
                
                $scope.$watch(function () { return $scope.indeterminate; },
                    function (newValue) {
                        if (!newValue) {
                ...
                $scope.$watch(function () { return $scope.buffering; },
                    function (newValue) {
                        if (newValue) {
                ...
                $scope.$watch(function () { return $scope.percentage; },
                    function (newValue) { progressBar.setPercentage(newValue); });
            }
        };
    }
    ...
    function ProgressButtonFloatingDirective($progressFAB) {
        return {
            ...
            link: function ($scope, $element) {
                ...
                $scope.$watch(function () { return $scope.ngStart; },
                    function (newValue) {
                ...
                $scope.$watch(function () { return $scope.ngFinish; },
                    function (newValue) {
                ...
                $scope.$watch(function () { return $scope.ngRestore; },
                    function (newValue) {
                ...
                circular.animationend(function (event) {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                function showSuggestions() {
                    if (!$scope.selectStart && !$scope.disabledAutoclose)
                        $body.on(eventID, function ($event) {
                            if (!$scope.showList) return; // Lista cerrada
                            
                            $scope.$apply(function () { closeSelect($event); });
                        }); // Cerrado automatico
                ...
                $scope.$on("$destroy", function () { $body.off(eventID); });
            }
        };
    }
    ...
    function SelectMultipleDirective($window, $body) {
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $scope.ngModel.forEach(function (select) {
    ...
    function SidenavDirective($sidenav) {
        ...
        return {
            ...
            link: function ($scope, $element) {
                ...
                button.click(function () { sidenav.hide(); });
                backdrop.click(function () { sidenav.hide(); });
            ...
            link: function ($scope, $element) {
                ...
                $element.displaceLeft(function (name, event) {
                    switch (name) {
                        ...
                        case ("end"): 
                            $timeout(function () { clickActive = true; }, 100);
                        break;
                    }
                }); 
        ...
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $element.on("click", function ($event) {
                    $scope.$apply(function () { listener.launch(Listeners.CLICK, { $event: $event }); });
                });
    ...
    function TooltipDirective($container) {
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $attrs.$observe("tooltip", function () { p.text($attrs.tooltip); });
                ...
                $element.on("mouseout", function () { tooltip.removeClass(Classes.SHOW); });
            
                $scope.$on("$destroy", function () { tooltip.remove(); }); 
            }
        };
    }
    ...
    function VideoYouTubeDirective() {
        return {
            ...
            link: function ($scope, $element) {
                ...
                $scope.$watch(function () { return $scope.ngSrc; },
                    function (newValue) {
    ...
    function ViewDirective() {
        return {
            ...
            link: function ($scope, $element) {
                ...
                $scope.$watch(function () { return $scope.ngActive; }, 
                    function (newValue) {
            ...
            link: function ($scope, $element) {
                ...
                function defineYears(year) {
                    ...
                    $element.animate({ scrollTop: topNow }, {
                        duration: 100, complete: function () { disabledScroll = false; }
                    });
    ...
    function FormNavigationProvider() {
        ...
        FormNavigation.prototype.show = function () {
            ...
            executeIfExists(formNavigation, function () {
    ...
    function ModalProvider() {
        ...
        function createModal() {
            ...
            backdrop.on("click", function () { if (persistent) provider.hide(); });

            btnPositive.on("click", function () { 
                if (softtion.isFunction(provider.fnPositive))
                    $scope.$apply(function () { provider.fnPositive(); });
            ...
            btnNegative.on("click", function () { 
                if (softtion.isFunction(provider.fnNegative))
                    $scope.$apply(function () { provider.fnNegative();  });
    ...
    function ProgressBarProvider() {
        ...
        ProgressBar.prototype.show = function () {
            ...
            executeIfExists(element, 
                function () { element.addClass(Classes.SHOW); }
            );
        ...
        ProgressBar.prototype.hide = function () {
            ...
            executeIfExists(element, 
                function () { element.removeClass(Classes.SHOW); }
            );
    ...
    function ProgressCircularProvider() {
        ...
        ProgressCircular.prototype.determinate = function (duration, round, fn) {
            ...
            executeIfExists(self.element, function () {
                ...
                if (!self.start) {
                    ...
                    self.element.animationend(function () { 
        ...
        ProgressCircularProvider.refresh = {
            show: function () {
                ...
                executeIfExists(refresh, function () { refresh.addClass(Classes.SHOW); });
            },

            hide: function () {
                executeIfExists(refresh, function () { refresh.removeClass(Classes.SHOW); });
            }
        };
    ...
    function ProgressFABProvider() {
        ...
        ProgressFAB.prototype.show = function() {
            ...
            executeIfExists(element, function () { 
    ...
    function SnackbarProvider($material) {
        ...
        SnackBar.prototype.show = function (text, options) {
            ...
            if (!snackbar.hasClass(Classes.SHOW)) {
                ...
                promise = $timeout(function () { hideSnackbar(); }, $duration);
            } else {
                if (softtion.isDefined(promise)) $timeout.cancel(promise); 
                
                hideSnackbar(); $timeout(function () { self.show(text, options); }, 160);
            }
        };
        ...
        function createSnackbar() {
            ...
            action.click(function () {
                ...
                $scope.$apply(function () { provider.functionAction(); });
    ...
    function ToastProvider($material) {
        ...
        Toast.prototype.show = function (text) {
            ...
            if (!toast.hasClass(Classes.SHOW)) {
                ...
                promise = $timeout(function () { hideToast(); }, $duration);
            } else {
                if (softtion.isDefined(promise)) $timeout.cancel(promise);

                var self = this; hideToast(); 
                
                $timeout(function () { self.show(text); }, 160); // Reactivando
            }
        };
    ...
    function TooltipContainerProvider() {
        ...
        function fnProvider($body, $windowResize, $window) { 
            ...
            $windowResize.addListener(tooltipWR, function (window) {
    ...
    function MaterialThemeProvider() {
        ...
        MaterialTheme.prototype.setTheme = function (theme, color) {
            ...
            angular.forEach(pallete, function (item, key) {
    ...
    function WindowResizeProvider() {
        ...
        var fnProvider = function ($scope, $window) { 
            ...
            window.resize(function (event) {
                $scope.$apply(function () {
                    angular.forEach(listeners, function (fn) { fn(window, event, $window); });
                });
            });
    ...
    function BottomSheetProperty($bottomSheet) {
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $element.on("click", function () { bottomSheet.show(); });
            }
        };
    }
    ...
    function DialogProperty($dialog) {
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $element.on("click", function () { dialog.show(); });
            }
        };
    }
    ...
    function FormNavigationProperty($formNavigation) {
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $element.on("click", function () { formNavigation.show(); });
            }
        };
    }
    ...
    function NgColorProperty($themes) {
        return {
            restrict: "A",
            link: function ($scope, $element, $attrs) {
                $attrs.$observe("ngColor", function () {
    ...
    function NgThemeProperty($themes) {
        return {
            restrict: "A",
            link: function ($scope, $element, $attrs) {
                $attrs.$observe("ngTheme", function () {
    ...
    function NgInactiveProperty() {
        return {
            restrict: "A",
            link: function ($scope, $element) {
                $scope.$watch(function () { return $scope.ngInactive; }, 
                    function (newValue) {
    ...
    function NgMaterialProperty() {
        return {
            restrict: "A",
            link: function ($scope, $element, $attrs) {
                $attrs.$observe("ngMaterial", function () {
    ...
    function RatioElementProperty($services) {
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $attrs.$observe("ratioElement", function () { 
    ...
    function SidenavProperty($sidenav) {
        return {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $element.on("click", function () { sidenav.show(); });
            }
        };
    }
    ...
    function defineInputField($scope, $element, $attrs, listener) {
        ...
        $attrs.$observe("iconAction", function () {
    ...
    function defineInputComponent($scope, $element, $attrs) {
        ...
        $scope.$watch(function () { return $scope.autocomplete; }, 
            function (newValue) {
    ...
    function defineAreaComponent($scope, $element, $attrs) {
        ...
        hidden.resize(function () { area.css("height", hidden.height() + "px"); });
    ...
    ngMaterial.run(["$templateCache", "$appContent",
        function ($templateCache, $appContent) {
            ...
            setTimeout(function () { $appContent.focus(); }, 325);
        }
    ]);
